# github-markdown-toc-markdownlint-compatible

## Motivation

To make the repo compatible with the MS Vscode markdownlint's extension rule

## Reason

Org repo not compatible with markdownlint extensions

## Steps

- disable markdown lint rules of original README.md - From here in the document to the end
<!-- markdownlint-disable -->
- disable CSpell of original README.md - From here in the document to the end
<!-- cSpell:disable -->
- Download original
- Using of command line
- Replace the bullet point stars with hyphen
<!-- keep the format-->


## original content of repo
<!-- keep the format-->
gh-md-toc
=========
